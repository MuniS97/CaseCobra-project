  ...
  return (
    <div className="bg-slate-50 ">
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "I usually keep my phone together with my keys in my pocket and tat led to some pretty heavy scratchmarks on all of my last phone cases. Thsi one, besides a barely noticeable scratch on the corner,{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
